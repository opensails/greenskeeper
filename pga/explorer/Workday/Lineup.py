...
class Lineups:
    ...
    def score_player(self, Wputting, Waround, Wapproach, Wttg, Wott, version=''):
        ...
        self.salaries['AvgPointsPerGame'] = (self.sg_putting * Wputting) + (self.sg_around * Waround) + (
                    self.sg_approach * Wapproach) + (self.sg_ttg * Wttg) + (self.sg_ott * Wott)
        ...
        print(
            f'SG: Putting-AVERAGE {Wputting}% || SG: Approach the Green-AVERAGE {Waround}% || SG: Tee-to-Green-AVERAGE {Wapproach}% || SG: Off-the-Tee-AVERAGE {Wttg}% || SG: Around-the-Green-AVERAGE{Wott}%')
    ...
    def top_dogs(self, Wputting, Waround, Wapproach, Wttg, Wott, version=''):
        self.topdogs['AvgPointsPerGame'] = (self.sg_putting * Wputting) + (self.sg_around * Waround) + (
                    self.sg_approach * Wapproach) + (self.sg_ttg * Wttg) + (self.sg_ott * Wott)
    ...
    def dark_horse(self, Wputting, Waround, Wapproach, Wttg, Wott, version=''):
        self.darkhorse['AvgPointsPerGame'] = (self.sg_putting * Wputting) + (self.sg_around * Waround) + (
                    self.sg_approach * Wapproach) + (self.sg_ttg * Wttg) + (self.sg_ott * Wott)
